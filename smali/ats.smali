...
.field private mScaleModeListener:Lati;
...
.method public constructor <init>(Latj;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lats;->mClearColor:[F

    .line 34
    const/4 v0, 0x1

    iput-boolean v0, p0, Lats;->mFlipVertically:Z

    .line 36
    const/4 v0, 0x0

    iput-object v0, p0, Lats;->mRequestedScaleMode:Ljava/lang/String;
    ...
    iput-object v0, p0, Lats;->mScaleModeListener:Lati;
...
.method static synthetic access$000(Lats;)Ljava/lang/String;
    .locals 1

    .prologue
    .line 26
    iget-object v0, p0, Lats;->mRequestedScaleMode:Ljava/lang/String;

    return-object v0
.end method

.method static synthetic access$002(Lats;Ljava/lang/String;)Ljava/lang/String;
    .locals 0

    .prologue
    .line 26
    iput-object p1, p0, Lats;->mRequestedScaleMode:Ljava/lang/String;
...
.method public bindToView(Landroid/view/View;)V
    ...
    .prologue
    .line 51
    invoke-virtual {p0}, Lats;->isRunning()Z
    ...
    .line 55
    :cond_0
    invoke-virtual {p0, p1}, Lats;->onBindToView(Landroid/view/View;)V

    .line 56
    return-void
.end method

.method public connectViewInputs(Latg;)V
    .locals 3
    ...
    .line 123
    iget-object v0, p0, Lats;->mScaleModeListener:Lati;

    .line 2118
    invoke-virtual {p1}, Latg;->c()V

    .line 2119
    iput-object v0, p1, Latg;->d:Lati;
...
.method public setupShader(Latd;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    .locals 5
    ...
    .line 132
    invoke-virtual {p0, p2, p3}, Lats;->getTargetRect(Landroid/graphics/Rect;Landroid/graphics/Rect;)Landroid/graphics/RectF;
    ...
    invoke-virtual {p1, v1}, Latd;->b([F)V

    .line 3518
    iput-boolean v4, p1, Latd;->a:Z

    .line 134
    iget-object v0, p0, Lats;->mClearColor:[F

    .line 3526
    iput-object v0, p1, Latd;->b:[F

    .line 135
    iget-boolean v0, p0, Lats;->mFlipVertically:Z
