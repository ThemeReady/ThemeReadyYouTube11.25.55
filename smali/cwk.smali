...
.method public a(Lcwl;)V
    ...
    .prologue
    .line 165
    invoke-interface {p1, p0}, Lcwl;->a(Lcwk;)V
...
.method public b()Landroid/content/Intent;
    ...
    invoke-virtual {p0}, Lcwk;->getIntent()Landroid/content/Intent;
    ...
    .line 170
    invoke-virtual {p0}, Lcwk;->c()Ljava/lang/Class;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 115
    invoke-virtual {p0}, Lcwk;->getApplication()Landroid/app/Application;
    ...
    invoke-direct {v3, p0}, Lbrl;-><init>(Landroid/app/Activity;)V

    .line 117
    invoke-interface {v0, v3}, Lcwm;->a(Lbrl;)Lcwl;

    move-result-object v0

    .line 114
    invoke-virtual {p0, v0}, Lcwk;->a(Lcwl;)V

    .line 119
    iget-object v0, p0, Lcwk;->c:Llsx;

    iget-boolean v3, p0, Lcwk;->d:Z

    invoke-interface {v0, v3}, Llsx;->a(Z)Z
    ...
    invoke-static {p0, v0, v2}, Llqz;->a(Landroid/content/Context;II)V

    .line 149
    :goto_0
    invoke-virtual {p0}, Lcwk;->finish()V
    ...
    .line 122
    :cond_0
    invoke-virtual {p0}, Lcwk;->getApplicationContext()Landroid/content/Context;

    move-result-object v0

    iget-object v3, p0, Lcwk;->b:Lcep;

    iget-object v4, p0, Lcwk;->a:Landroid/content/SharedPreferences;
    ...
    .line 1082
    invoke-static {v0}, Lltm;->b(Landroid/content/Context;)I

    move-result v5

    .line 2053
    iget-object v0, v3, Lcep;->a:Llsn;

    const-string v6, "min_app_version"

    invoke-virtual {v0, v6, v1}, Llsn;->a(Ljava/lang/String;I)I
    ...
    invoke-virtual {v0, v7, v1}, Llsn;->a(Ljava/lang/String;I)I
    ...
    .line 2067
    invoke-virtual {v0, v8, v9}, Llsn;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    .line 2066
    invoke-static {v0}, Lcep;->a(Ljava/lang/String;)Landroid/util/SparseBooleanArray;

    move-result-object v0

    .line 2071
    iget-object v8, v3, Lcep;->a:Llsn;
    ...
    .line 2072
    invoke-virtual {v8, v9, v10}, Llsn;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v8

    .line 2071
    invoke-static {v8}, Lcep;->a(Ljava/lang/String;)Landroid/util/SparseBooleanArray;

    move-result-object v8

    .line 2089
    iget-object v3, v3, Lcep;->a:Llsn;

    const-string v9, "time_between_upgrade_prompts_millis"

    .line 3075
    iget-object v10, v3, Llsn;->b:Landroid/content/ContentResolver;

    invoke-virtual {v3, v9}, Llsn;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    const-wide/32 v12, 0x240c8400

    invoke-static {v10, v3, v12, v13}, Limq;->a(Landroid/content/ContentResolver;Ljava/lang/String;J)J
    ...
    invoke-virtual {p0}, Lcwk;->b()Landroid/content/Intent;
    ...
    .line 139
    iget-object v1, p0, Lcwk;->a:Landroid/content/SharedPreferences;
    ...
    .line 142
    invoke-virtual {p0, v0}, Lcwk;->startActivity(Landroid/content/Intent;)V
    ...
    invoke-virtual {p0, v0, v1}, Lcwk;->overridePendingTransition(II)V
