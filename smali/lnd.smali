...
# direct methods
.method constructor <init>(Llip;Llel;)V
    .locals 1
    ...
    iput-object v0, p0, Llnd;->b:Llel;

    .line 62
    return-void
.end method

.method private static a(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Lavi;)V
    .locals 2

    .prologue
    .line 178
    invoke-virtual {p1}, Lavi;->q()[B
...
# virtual methods
.method public final a(Lavi;Ljava/util/Map;)Lorg/apache/http/HttpResponse;
    .locals 6
    ...
    .line 74
    invoke-virtual {p1}, Lavi;->b()Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Lavi;->l()Ljava/lang/String;
    ...
    .line 83
    :goto_1
    invoke-static {v2, p2}, Llnd;->a(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/util/Map;)V

    .line 84
    invoke-virtual {p1}, Lavi;->i()Ljava/util/Map;

    move-result-object v3

    invoke-static {v2, v3}, Llnd;->a(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/util/Map;)V
    ...
    invoke-interface {v3}, Lavq;->ag_()I
    ...
    .line 2109
    sget-object v5, Llne;->a:[I

    invoke-virtual {v3}, Lavk;->ordinal()I
    ...
    .line 93
    iget-object v3, p0, Llnd;->b:Llel;

    invoke-virtual {v3, v1}, Llel;->d(Ljava/lang/Object;)V

    .line 3104
    :cond_0
    iget-object v1, p0, Llnd;->a:Llip;
    ...
    .line 97
    iget-object v2, p0, Llnd;->b:Llel;

    invoke-virtual {v2, v0}, Llel;->d(Ljava/lang/Object;)V
    ...
    invoke-virtual {p1}, Lavi;->p()Ljava/lang/String;
    ...
    .line 1151
    invoke-static {v2, p1}, Llnd;->a(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Lavi;)V
    ...
    invoke-direct {v2, v3}, Lawe;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3, v4}, Lawe;->addHeader(Ljava/lang/String;Ljava/lang/String;)V
