...
# direct methods
.method constructor <init>(Lhey;Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenRequest;)V
    .locals 0

    iput-object p2, p0, Lhov;->a:Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenRequest;

    invoke-direct {p0, p1}, Likv;-><init>(Lhey;)V
...
.method protected final synthetic a(Lcom/google/android/gms/common/api/Status;)Lhfh;
    ...
    invoke-direct {v1, p1, v0}, Lilc;-><init>(Lcom/google/android/gms/common/api/Status;Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenResponse;)V
...
.method protected final synthetic a(Lhev;)V
    ...
    .line 1000
    iget-object v1, p0, Lhov;->a:Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenRequest;

    .line 2000
    new-instance v2, Lhot;

    invoke-direct {v2, p0}, Lhot;-><init>(Lhfo;)V

    .line 3000
    iget v0, p1, Lhor;->b:I

    iget-object v3, p1, Lhor;->a:Landroid/content/Context;

    invoke-virtual {v3}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v3

    iget-object v4, p1, Lhor;->c:Ljava/lang/String;

    iget v5, p1, Lhor;->d:I

    iget-boolean v6, p1, Lhor;->e:Z
    ...
    .line 2000
    :try_start_0
    invoke-virtual {p1}, Lhor;->l()Landroid/os/IInterface;

    move-result-object v0

    check-cast v0, Lhoh;

    invoke-interface {v0, v1, v7, v2}, Lhoh;->a(Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenRequest;Landroid/os/Bundle;Lhon;)V
    :try_end_0
    ...
    invoke-virtual {v2, v1, v0, v3}, Lhot;->a(Lcom/google/android/gms/common/api/Status;Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenResponse;Landroid/os/Bundle;)V
