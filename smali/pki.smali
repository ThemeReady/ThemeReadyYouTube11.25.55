...
.method protected final onAttachedToWindow()V
    ...
    .line 38
    iget-object v0, p0, Lpki;->b:Landroid/view/View;
    ...
    invoke-virtual {p0, v0}, Lpki;->removeView(Landroid/view/View;)V

    .line 40
    const/4 v0, 0x0

    iput-object v0, p0, Lpki;->b:Landroid/view/View;

    .line 43
    :cond_0
    invoke-virtual {p0}, Lpki;->isHardwareAccelerated()Z
    ...
    invoke-virtual {p0}, Lpki;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-direct {v0, v1}, Lpko;-><init>(Landroid/content/Context;)V

    .line 45
    iput-object v0, p0, Lpki;->a:Lpkd;
    ...
    invoke-virtual {p0, v0}, Lpki;->addView(Landroid/view/View;)V

    .line 54
    iget-boolean v0, p0, Lpki;->c:Z

    if-eqz v0, :cond_1

    .line 55
    iput-boolean v2, p0, Lpki;->c:Z

    .line 56
    iget-object v0, p0, Lpki;->a:Lpkd;

    iget-object v1, p0, Lpki;->e:Lpke;

    invoke-interface {v0, v1}, Lpkd;->a(Lpke;)V

    .line 57
    iget-boolean v0, p0, Lpki;->d:Z

    if-eqz v0, :cond_1

    .line 58
    invoke-virtual {p0, v2}, Lpki;->a(I)V
...
.method protected final onLayout(ZIIII)V
    ...
    .line 76
    invoke-virtual {p0}, Lpki;->getChildCount()I
    ...
    .line 77
    invoke-virtual {p0, v3}, Lpki;->getChildAt(I)Landroid/view/View;
...
.method protected final onMeasure(II)V
    ...
    .line 66
    invoke-virtual {p0, v1}, Lpki;->getChildAt(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v1, v0}, Lpki;->setMeasuredDimension(II)V
    ...
    .line 70
    :cond_0
    invoke-virtual {p0, v1, v1}, Lpki;->setMeasuredDimension(II)V
