...
.field private final E:Lfyv;

.field private final F:Lfyh;

.field private final G:Lgcr;

.field private final H:Lfzd;

.field private final I:Lgbn;

.field private final J:Lgbw;
...
.method private constructor <init>(Landroid/content/Context;Landroid/app/Activity;Lcom/google/android/apps/youtube/embeddedplayer/service/service/jar/IApiPlayerFactoryService;Z)V
    ...
    invoke-direct {v0, p2, v1, v2, v3}, Lfzb;-><init>(Landroid/content/Context;Landroid/content/res/Resources;Ljava/lang/ClassLoader;Landroid/content/res/Resources$Theme;)V

    .line 158
    new-instance v1, Lfvz;

    invoke-direct {v1, p2}, Lfvz;-><init>(Landroid/app/Activity;)V

    invoke-direct {p0, v0, v1, p3, p4}, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;-><init>(Landroid/content/Context;Lfvz;Lcom/google/android/apps/youtube/embeddedplayer/service/service/jar/IApiPlayerFactoryService;Z)V

    .line 160
    return-void
.end method

.method private constructor <init>(Landroid/content/Context;Lfvz;Lcom/google/android/apps/youtube/embeddedplayer/service/service/jar/IApiPlayerFactoryService;Z)V
    .locals 14
    ...
    invoke-direct {v1, p1}, Lrot;-><init>(Landroid/content/Context;)V

    move-object/from16 v0, p2

    invoke-direct {p0, p1, v0, v1}, Lfxl;-><init>(Landroid/content/Context;Lfvz;Lrot;)V
    ...
    invoke-direct {v1, p1, p0}, Lfxf;-><init>(Landroid/content/Context;Lfwe;)V
    ...
    invoke-direct {v2, v1, p1, v3}, Lgcc;-><init>(Lgcm;Landroid/content/Context;Landroid/os/Handler;)V

    iput-object v2, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->C:Lgcc;

    .line 190
    const/4 v2, 0x0

    iput-object v2, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->D:Lgcn;

    .line 198
    :goto_0
    iget-object v2, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->b:Lrot;

    invoke-interface {v1}, Lfwc;->a()Landroid/view/View;

    move-result-object v3

    invoke-virtual {v2, v3}, Lrot;->b(Landroid/view/View;)V

    .line 200
    new-instance v2, Lgbs;

    iget-object v3, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->b:Lrot;

    iget-object v4, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->a:Landroid/os/Handler;

    invoke-direct {v2, v3, v4}, Lgbs;-><init>(Lrov;Landroid/os/Handler;)V

    iput-object v2, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->B:Lgbs;
    ...
    invoke-direct {v2, v1, v3}, Lfyv;-><init>(Lfwc;Landroid/os/Handler;)V

    iput-object v2, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->E:Lfyv;

    .line 202
    new-instance v1, Lfyh;

    iget-object v2, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->h:Lknf;

    iget-object v3, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->a:Landroid/os/Handler;

    invoke-direct {v1, v2, v3}, Lfyh;-><init>(Lknf;Landroid/os/Handler;)V

    iput-object v1, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->F:Lfyh;

    .line 203
    new-instance v1, Lgcr;

    iget-object v2, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->i:Lkne;

    iget-object v3, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->a:Landroid/os/Handler;

    invoke-direct {v1, v2, v3}, Lgcr;-><init>(Lkny;Landroid/os/Handler;)V

    iput-object v1, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->G:Lgcr;

    .line 204
    new-instance v1, Lfzd;

    iget-object v2, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->c:Lrne;

    iget-object v3, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->d:Lrng;

    iget-object v4, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->e:Lrni;

    iget-object v5, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->f:Lrnf;

    iget-object v6, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->g:Lfxc;

    iget-object v7, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->a:Landroid/os/Handler;

    invoke-direct/range {v1 .. v7}, Lfzd;-><init>(Lrlx;Lrpd;Lrpw;Lrox;Lfxc;Landroid/os/Handler;)V

    iput-object v1, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->H:Lfzd;

    .line 212
    new-instance v1, Lgbn;

    iget-object v2, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->j:Lrms;

    iget-object v3, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->a:Landroid/os/Handler;

    invoke-direct {v1, v2, v3}, Lgbn;-><init>(Lrno;Landroid/os/Handler;)V

    iput-object v1, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->I:Lgbn;

    .line 213
    new-instance v1, Lgbw;

    iget-object v2, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->k:Lrnb;

    iget-object v3, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->a:Landroid/os/Handler;

    invoke-direct {v1, v2, v3}, Lgbw;-><init>(Lrpg;Landroid/os/Handler;)V

    iput-object v1, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->J:Lgbw;
    ...
    invoke-direct {v1, v2, v3}, Lgcz;-><init>(Lrpi;Landroid/os/Handler;)V

    iput-object v1, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->K:Lgcz;

    .line 216
    new-instance v2, Lwep;

    .line 1597
    invoke-direct {v2, p0}, Lwep;-><init>(Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;)V

    .line 216
    iget-object v3, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->B:Lgbs;

    iget-object v4, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->C:Lgcc;

    iget-object v5, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->D:Lgcn;

    iget-object v6, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->E:Lfyv;

    iget-object v7, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->F:Lfyh;

    iget-object v8, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->G:Lgcr;

    iget-object v9, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->H:Lfzd;

    iget-object v10, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->I:Lgbn;

    iget-object v11, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->J:Lgbw;

    iget-object v12, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->K:Lgcz;

    move-object/from16 v1, p3

    move/from16 v13, p4

    invoke-interface/range {v1 .. v13}, Lcom/google/android/apps/youtube/embeddedplayer/service/service/jar/IApiPlayerFactoryService;->a(Lgaj;Lgav;Lgbb;Lgbe;Lgag;Lgad;Lgbh;Lgam;Lgas;Lgay;Lgbk;Z)Lcom/google/android/apps/youtube/embeddedplayer/service/service/jar/IApiPlayerService;
    ...
    invoke-direct {v1, p1, p0}, Lfxh;-><init>(Landroid/content/Context;Lfxi;)V
    ...
    invoke-direct {v2, v1, p1, v3}, Lgcn;-><init>(Lgcq;Landroid/content/Context;Landroid/os/Handler;)V
...
.method public constructor <init>(Landroid/os/IBinder;Landroid/os/IBinder;Landroid/os/IBinder;Z)V
    ...
    .prologue
    .line 145
    invoke-static {p1}, Lwgs;->a(Landroid/os/IBinder;)Lwgr;
    ...
    .line 146
    invoke-static {p2}, Lwgs;->a(Landroid/os/IBinder;)Lwgr;

    move-result-object v1

    invoke-static {v1}, Lwgu;->a(Lwgr;)Ljava/lang/Object;
...
.method public final c()V
    ...
    .line 820
    sget-object v0, Lwfl;->j:Lwfl;

    invoke-virtual {p0, v0}, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->a(Lwfl;)V
...
.method public final j(Z)V
    ...
    .line 391
    iget-object v0, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->C:Lgcc;
    ...
    .line 2049
    iget-object v1, v0, Lgcc;->a:Lgcm;

    invoke-interface {v1}, Lgcm;->e()V

    .line 2050
    iget-object v1, v0, Lgcc;->c:Lgcl;
    ...
    iput-object v2, v1, Lgcl;->a:Lcom/google/android/apps/youtube/embeddedplayer/service/service/jar/ISurfaceHolderService;

    .line 2181
    const/4 v2, 0x0

    iput-object v2, v1, Lgcl;->b:Lgcm;
    ...
    iput-object v1, v0, Lgcc;->d:Landroid/view/SurfaceHolder;

    .line 394
    :cond_1
    iget-object v0, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->D:Lgcn;
    ...
    .line 3045
    iget-object v1, v0, Lgcn;->a:Lgcq;

    invoke-interface {v1}, Lgcq;->e()V

    .line 3046
    iget-object v1, v0, Lgcn;->c:Lgcp;
    ...
    iput-object v2, v1, Lgcp;->a:Lcom/google/android/apps/youtube/embeddedplayer/service/service/jar/ISurfaceTextureService;

    .line 3077
    const/4 v2, 0x0

    iput-object v2, v1, Lgcp;->b:Lgcq;
    ...
    .line 397
    :cond_2
    iget-object v0, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->B:Lgbs;

    .line 4029
    iget-object v1, v0, Lgbs;->b:Lgbv;
    ...
    iput-object v2, v1, Lgbv;->a:Lcom/google/android/apps/youtube/embeddedplayer/service/service/jar/IPlayerUiService;
    ...
    .line 398
    :cond_3
    iget-object v0, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->F:Lfyh;

    .line 5032
    iget-object v1, v0, Lfyh;->b:Lfyu;
    ...
    iput-object v2, v1, Lfyu;->a:Lcom/google/android/apps/youtube/embeddedplayer/service/service/jar/IAdOverlayService;
    ...
    .line 399
    :cond_4
    iget-object v0, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->H:Lfzd;

    .line 6059
    iget-object v1, v0, Lfzd;->f:Lgac;
    ...
    iput-object v2, v1, Lgac;->a:Lcom/google/android/apps/youtube/embeddedplayer/service/service/jar/IControlsOverlayService;
    ...
    .line 400
    :cond_5
    iget-object v0, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->I:Lgbn;

    .line 7029
    iget-object v1, v0, Lgbn;->b:Lgbr;
    ...
    iput-object v2, v1, Lgbr;->a:Lcom/google/android/apps/youtube/embeddedplayer/service/service/jar/ILiveOverlayService;
    ...
    .line 401
    :cond_6
    iget-object v0, p0, Lcom/google/android/youtube/api/jar/client/RemoteEmbeddedPlayer;->G:Lgcr;

    .line 8032
    iget-object v1, v0, Lgcr;->b:Lgcy;
    ...
    iput-object v2, v1, Lgcy;->a:Lcom/google/android/apps/youtube/embeddedplayer/service/service/jar/ISurveyOverlayService;
