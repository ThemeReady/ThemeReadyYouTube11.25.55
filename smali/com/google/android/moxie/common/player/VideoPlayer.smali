...
.field private x:Lgfa;

.field private y:Lgge;


# direct methods
.method public constructor <init>(Landroid/content/Context;Lwcd;)V
    .locals 4
    ...
    invoke-direct {v0, p0}, Lwca;-><init>(Lcom/google/android/moxie/common/player/VideoPlayer;)V
    ...
    invoke-direct {v0, p0}, Lwcb;-><init>(Lcom/google/android/moxie/common/player/VideoPlayer;)V

    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->x:Lgfa;
    ...
    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->y:Lgge;

    .line 162
    iput-object p1, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->e:Landroid/content/Context;

    .line 163
    iput-object p2, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->b:Lwcd;
    ...
    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->f:Lgex;

    .line 165
    iget-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->f:Lgex;

    iget-object v1, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->x:Lgfa;
    ...
    invoke-interface {v0, v3}, Lgex;->a(Z)V

    .line 167
    new-instance v0, Lgsc;

    iget-object v1, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->f:Lgex;

    invoke-direct {v0, v1}, Lgsc;-><init>(Lgex;)V

    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->j:Lgsc;
...
.method public static create(Landroid/content/Context;Lwcd;)Lcom/google/android/moxie/common/player/VideoPlayer;
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Lcom/google/android/moxie/common/player/VideoPlayer;-><init>(Landroid/content/Context;Lwcd;)V
...
.method public close()V
    ...
    .line 270
    iput-object v2, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->s:Lggr;
...
.method public getPlayerControl()Lgsc;
    .locals 1

    .prologue
    .line 386
    iget-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->j:Lgsc;
...
.method public open(Ljava/lang/String;I)V
    ...
    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->r:Lwbz;
    ...
    iget-object v3, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->r:Lwbz;

    iget-object v6, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->y:Lgge;

    invoke-static/range {v0 .. v6}, Lwce;->a(Landroid/content/Context;Landroid/os/Handler;Ljava/lang/String;Lgfg;Ljava/lang/String;ILgge;)Lwce;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->s:Lggr;

    .line 2222
    iget-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->s:Lggr;
    ...
    iget-object v1, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->s:Lggr;

    iget-object v2, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->m:Landroid/view/Surface;

    invoke-interface {v0, v1, v7, v2}, Lgex;->a(Lgey;ILjava/lang/Object;)V

    .line 2226
    iget-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->f:Lgex;

    new-array v1, v7, [Lggr;

    iget-object v2, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->s:Lggr;
...
.method public pause()V
    ...
    .line 306
    iget-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->r:Lwbz;
...
.method public play(JJZ)V
    ...
    .line 287
    :cond_1
    iget-object v2, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->f:Lgex;

    invoke-interface {v2}, Lgex;->f()J
...
.method public update(J)Z
    ...
    .line 3048
    iput-wide v2, v0, Lwbz;->a:J

    .line 3049
    invoke-static {v2, v3}, Lwbz;->a(J)J

    move-result-wide v2

    iput-wide v2, v0, Lwbz;->b:J
