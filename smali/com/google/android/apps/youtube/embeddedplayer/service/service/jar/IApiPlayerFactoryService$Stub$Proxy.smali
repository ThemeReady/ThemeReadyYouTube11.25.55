...
# virtual methods
.method public final a(Lgaj;Lgav;Lgbb;Lgbe;Lgag;Lgad;Lgbh;Lgam;Lgas;Lgay;Lgbk;Z)Lcom/google/android/apps/youtube/embeddedplayer/service/service/jar/IApiPlayerService;
    .locals 5
    ...
    invoke-interface {p1}, Lgaj;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p2}, Lgav;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p3}, Lgbb;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p4}, Lgbe;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p5}, Lgag;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p6}, Lgad;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p7}, Lgbh;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p8}, Lgam;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p9}, Lgas;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p10}, Lgay;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface/range {p11 .. p11}, Lgbk;->asBinder()Landroid/os/IBinder;
