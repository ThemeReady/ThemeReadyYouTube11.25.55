...
.method private static a(Ljava/lang/String;)Llgh;
    .locals 5
...
# virtual methods
.method public final a(Lhmf;)I
    .locals 2

    .prologue
    .line 65
    iget-object v0, p0, Lcom/google/android/libraries/youtube/common/gcore/gcoreclient/gcm/impl/GcmTaskServiceDelegator;->a:Llgh;

    new-instance v1, Llhm;

    invoke-direct {v1, p1}, Llhm;-><init>(Lhmf;)V

    invoke-interface {v0, v1}, Llgh;->a(Llgq;)I
...
.method public onCreate()V
    ...
    .prologue
    .line 30
    invoke-super {p0}, Lhlq;->onCreate()V
    ...
    .line 46
    invoke-static {v0}, Lcom/google/android/libraries/youtube/common/gcore/gcoreclient/gcm/impl/GcmTaskServiceDelegator;->a(Ljava/lang/String;)Llgh;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/libraries/youtube/common/gcore/gcoreclient/gcm/impl/GcmTaskServiceDelegator;->a:Llgh;

    .line 49
    :cond_0
    iget-object v0, p0, Lcom/google/android/libraries/youtube/common/gcore/gcoreclient/gcm/impl/GcmTaskServiceDelegator;->a:Llgh;

    invoke-interface {v0, v1}, Llgh;->a(Landroid/content/Context;)V
