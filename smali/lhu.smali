...
# direct methods
.method public constructor <init>(Llip;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)V
    .locals 1
    ...
    invoke-direct {v0, p1}, Llhn;-><init>(Llip;)V

    iput-object v0, p0, Llhu;->a:Llhn;
    ...
    iput-object v0, p0, Llhu;->b:Landroid/net/Uri;
    ...
    .line 48
    iput-object p4, p0, Llhu;->d:Ljava/lang/String;

    .line 49
    return-void
.end method

.method private static a(Lorg/apache/http/HttpResponse;)Lwjr;
    .locals 3
...
.method private static b(Lorg/apache/http/HttpResponse;)Lwjq;
    .locals 3
...
# virtual methods
.method public final a(Llse;)Landroid/net/Uri;
    .locals 8
    ...
    .line 1135
    iget-object v1, p0, Llhu;->b:Landroid/net/Uri;
    ...
    invoke-virtual {v2, v1}, Lliz;->a(Landroid/net/Uri;)Lorg/apache/http/client/methods/HttpUriRequest;
    ...
    invoke-static {v2, v1}, Llhu;->a(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/lang/String;)V

    .line 61
    :goto_0
    invoke-virtual {p1}, Llse;->b()J
    ...
    .line 63
    :try_start_0
    iget-object v1, p0, Llhu;->a:Llhn;

    invoke-virtual {v1, v2}, Llhn;->a(Lorg/apache/http/client/methods/HttpUriRequest;)Lorg/apache/http/HttpResponse;

    move-result-object v1

    .line 64
    invoke-static {v1}, Llhu;->a(Lorg/apache/http/HttpResponse;)Lwjr;

    move-result-object v1

    .line 65
    iget-object v1, v1, Lwjr;->a:[Ljava/lang/String;
    ...
    .line 2078
    :cond_1
    iget-object v1, p1, Llse;->a:Llsg;

    .line 2135
    iget-wide v2, v1, Llsg;->c:J
...
.method public final a(Llho;Llse;)Llia;
    .locals 8
    ...
    .line 2147
    iget-object v0, p0, Llhu;->b:Landroid/net/Uri;
    ...
    .line 3021
    iget-object v2, p1, Llho;->a:Ljava/lang/String;
    ...
    invoke-virtual {v2, v0}, Lliz;->a(Landroid/net/Uri;)Lorg/apache/http/client/methods/HttpUriRequest;
    ...
    invoke-static {v2, v0}, Llhu;->a(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/lang/String;)V

    .line 106
    :goto_1
    invoke-virtual {p2}, Llse;->b()J
    ...
    .line 108
    :try_start_0
    iget-object v0, p0, Llhu;->a:Llhn;

    invoke-virtual {v0, v2}, Llhn;->a(Lorg/apache/http/client/methods/HttpUriRequest;)Lorg/apache/http/HttpResponse;
    :try_end_0
    .catch Lorg/apache/http/client/HttpResponseException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 129
    :cond_4
    invoke-static {v0}, Llhu;->b(Lorg/apache/http/HttpResponse;)Lwjq;
    ...
    iget-object v2, v1, Lwjq;->a:[Lwjo;

    iget-wide v4, v1, Lwjq;->b:J

    invoke-direct {v0, p1, v2, v4, v5}, Llia;-><init>(Llho;[Lwjo;J)V
