...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lbhh;->d:Ljava/util/Set;
    ...
    sput-object v0, Lbhh;->e:Ljava/util/Set;

    .line 82
    invoke-static {v4}, Lbmb;->a(I)Ljava/util/Queue;

    move-result-object v0

    sput-object v0, Lbhh;->f:Ljava/util/Queue;

    return-void
.end method

.method public constructor <init>(Landroid/util/DisplayMetrics;Lbbt;Lbbo;)V
    .locals 1
    ...
    iput-object v0, p0, Lbhh;->h:Landroid/util/DisplayMetrics;
...
.method private final a(Ljava/io/InputStream;)I
    ...
    iget-object v2, p0, Lbhh;->i:Lbbo;

    invoke-direct {v1, p1, v2}, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;-><init>(Ljava/io/InputStream;Lbbo;)V
...
.method private final a(Ljava/io/InputStream;Layc;)Landroid/graphics/Bitmap$Config;
    .locals 4
...
.method private static a(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;Lbhj;)Landroid/graphics/Bitmap;
    .locals 9
    ...
    .line 7060
    sget-object v3, Lbht;->a:Ljava/util/concurrent/locks/Lock;
    ...
    .line 8060
    sget-object v1, Lbht;->a:Ljava/util/concurrent/locks/Lock;
    ...
    .line 8488
    invoke-static {p1}, Lbhh;->b(Landroid/graphics/BitmapFactory$Options;)Ljava/lang/String;
...
.method private static b(Landroid/graphics/BitmapFactory$Options;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lbhh;->a(Landroid/graphics/Bitmap;)Ljava/lang/String;
...
.method private final b(Ljava/io/InputStream;)Z
    ...
    .line 356
    sget-object v1, Lbhh;->e:Ljava/util/Set;
...
.method private static declared-synchronized c()Landroid/graphics/BitmapFactory$Options;
    ...
    :try_start_0
    sget-object v2, Lbhh;->f:Ljava/util/Queue;
    ...
    .line 504
    :try_start_1
    sget-object v0, Lbhh;->f:Ljava/util/Queue;
    ...
    .line 508
    invoke-static {v0}, Lbhh;->d(Landroid/graphics/BitmapFactory$Options;)V
    :try_end_2
...
.method private static c(Landroid/graphics/BitmapFactory$Options;)V
    ...
    .prologue
    .line 515
    invoke-static {p0}, Lbhh;->d(Landroid/graphics/BitmapFactory$Options;)V

    .line 516
    sget-object v1, Lbhh;->f:Ljava/util/Queue;
...
# virtual methods
.method public final a(Ljava/io/InputStream;IILayk;Lbhj;)Lbbh;
    .locals 18
    ...
    invoke-static {v2, v3}, Lbma;->a(ZLjava/lang/String;)V

    .line 150
    move-object/from16 v0, p0

    iget-object v2, v0, Lbhh;->i:Lbbo;

    const/high16 v3, 0x10000

    const-class v4, [B

    invoke-interface {v2, v3, v4}, Lbbo;->a(ILjava/lang/Class;)Ljava/lang/Object;
    ...
    .line 151
    invoke-static {}, Lbhh;->c()Landroid/graphics/BitmapFactory$Options;
    ...
    .line 154
    sget-object v3, Lbhh;->a:Layh;

    move-object/from16 v0, p4

    invoke-virtual {v0, v3}, Layk;->a(Layh;)Ljava/lang/Object;
    ...
    .line 155
    sget-object v4, Lbhh;->b:Layh;

    move-object/from16 v0, p4

    invoke-virtual {v0, v4}, Layk;->a(Layh;)Ljava/lang/Object;
    ...
    invoke-static {v0, v10, v1}, Lbhh;->a(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;Lbhj;)Landroid/graphics/Bitmap;
    ...
    .line 3177
    invoke-direct/range {p0 .. p1}, Lbhh;->a(Ljava/io/InputStream;)I
    ...
    invoke-direct {v0, v1, v3}, Lbhh;->a(Ljava/io/InputStream;Layc;)Landroid/graphics/Bitmap$Config;
    ...
    .line 4316
    :cond_2
    invoke-direct/range {p0 .. p1}, Lbhh;->b(Ljava/io/InputStream;)Z
    ...
    .line 4318
    invoke-static {v10}, Lbhh;->a(Landroid/graphics/BitmapFactory$Options;)Z
    ...
    .line 4496
    invoke-interface {v4, v6, v8, v3}, Lbbt;->b(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    iget-object v3, v0, Lbhh;->g:Lbbt;

    move-object/from16 v0, p5

    invoke-interface {v0, v3, v4}, Lbhj;->a(Lbbt;Landroid/graphics/Bitmap;)V
    ...
    .line 5447
    invoke-static {v4}, Lbhh;->a(Landroid/graphics/Bitmap;)Ljava/lang/String;
    ...
    .line 5449
    invoke-static {v10}, Lbhh;->b(Landroid/graphics/BitmapFactory$Options;)Ljava/lang/String;
    ...
    iget-object v3, v0, Lbhh;->h:Landroid/util/DisplayMetrics;
    ...
    invoke-static {v3, v4, v12}, Lbht;->a(Lbbt;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    iget-object v5, v0, Lbhh;->g:Lbbt;

    invoke-interface {v5, v4}, Lbbt;->a(Landroid/graphics/Bitmap;)V
    ...
    invoke-static {v3, v4}, Lbgv;->a(Landroid/graphics/Bitmap;Lbbt;)Lbgv;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 162
    invoke-static {v10}, Lbhh;->c(Landroid/graphics/BitmapFactory$Options;)V

    .line 163
    move-object/from16 v0, p0

    iget-object v4, v0, Lbhh;->i:Lbbo;

    const-class v5, [B

    invoke-interface {v4, v2, v5}, Lbbo;->a(Ljava/lang/Object;Ljava/lang/Class;)V
    ...
    :cond_8
    :try_start_1
    invoke-virtual {v4, v9, v7, v6, v8}, Lbgz;->a(IIII)F
    ...
    :cond_b
    :try_start_2
    invoke-virtual {v4, v7, v9, v6, v8}, Lbgz;->a(IIII)F
    ...
    sget-object v13, Lbhh;->d:Ljava/util/Set;
