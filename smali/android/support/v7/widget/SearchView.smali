...
.field public static final HIDDEN_METHOD_INVOKER:Laqj;
...
.field private mOnCloseListener:Laqk;
...
.field private mOnQueryChangeListener:Laql;

.field private mOnQueryTextFocusChangeListener:Landroid/view/View$OnFocusChangeListener;

.field private mOnSearchClickListener:Landroid/view/View$OnClickListener;

.field private mOnSuggestionListener:Laqm;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/SearchView;->HIDDEN_METHOD_INVOKER:Laqj;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Lapx;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Laqg;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-virtual {v1, v2, v3}, Laqz;->e(II)I
    ...
    invoke-virtual {v1, v2}, Laqz;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v1, v0, v2}, Laqz;->e(II)I
    ...
    invoke-direct {v2, p0}, Laqd;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-virtual {v1, v0, v5}, Laqz;->a(IZ)Z
    ...
    invoke-virtual {v1, v0, v4}, Laqz;->c(II)I
    ...
    invoke-virtual {v1, v0, v4}, Laqz;->a(II)I
    ...
    .line 3181
    iget-object v0, v1, Laqz;->a:Landroid/content/res/TypedArray;
...
.method private addOnLayoutChangeListenerToDropDownAnchorSDK11()V
    ...
    invoke-direct {v1, p0}, Laqe;-><init>(Landroid/support/v7/widget/SearchView;)V
...
.method private createIntentFromSuggestion(Landroid/database/Cursor;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {p1, v0}, Laqr;->a(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v2}, Laqr;->a(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
...
.method private forceSuggestionQuery()V
    ...
    .prologue
    .line 1662
    sget-object v0, Landroid/support/v7/widget/SearchView;->HIDDEN_METHOD_INVOKER:Laqj;

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mSearchSrcTextView:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    .line 6843
    iget-object v2, v0, Laqj;->a:Ljava/lang/reflect/Method;

    if-eqz v2, :cond_0

    .line 6845
    :try_start_0
    iget-object v0, v0, Laqj;->a:Ljava/lang/reflect/Method;
    ...
    .line 6852
    iget-object v2, v0, Laqj;->b:Ljava/lang/reflect/Method;

    if-eqz v2, :cond_1

    .line 6854
    :try_start_1
    iget-object v0, v0, Laqj;->b:Ljava/lang/reflect/Method;
...
.method private onCloseClicked()V
    ...
    .line 1178
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Laqk;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Laqk;

    invoke-interface {v0}, Laqk;->a()Z
...
.method private onItemClicked(IILjava/lang/String;)Z
    ...
    .line 1351
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Laqm;

    if-eqz v1, :cond_0

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Laqm;

    invoke-interface {v1}, Laqm;->b()Z
...
.method private onItemSelected(I)Z
    ...
    .prologue
    .line 1362
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Laqm;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Laqm;

    invoke-interface {v0}, Laqm;->a()Z
...
.method private onSubmitQuery()V
    ...
    .line 1158
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Laql;
...
.method private onSuggestionsKey(Landroid/view/View;ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0, v1}, Laqj;->a(Landroid/widget/AutoCompleteTextView;)V
...
.method private onTextChanged(Ljava/lang/CharSequence;)V
    ...
    .line 1149
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Laql;
...
.method private updateSearchAutoComplete()V
    ...
    invoke-direct {v0, v2, p0, v3, v4}, Laqr;-><init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1321
    invoke-virtual {p1}, Laqn;->getSuperState()Landroid/os/Parcelable;
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v1, v0}, Laqn;-><init>(Landroid/os/Parcelable;)V
...
.method public setOnCloseListener(Laqk;)V
    .locals 0

    .prologue
    .line 534
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Laqk;
...
.method public setOnQueryTextListener(Laql;)V
    .locals 0

    .prologue
    .line 525
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Laql;
...
.method public setOnSuggestionListener(Laqm;)V
    .locals 0

    .prologue
    .line 552
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Laqm;
