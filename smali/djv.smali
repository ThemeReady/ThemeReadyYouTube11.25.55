...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lwwt;Lqfs;Lpqw;Ldjz;Lljx;Ldjq;)V
    .locals 3

    .prologue
    .line 74
    invoke-direct {p0, p2, p3}, Lqfr;-><init>(Lwwt;Lqfs;)V

    .line 79
    iput-object p1, p0, Ldjv;->d:Landroid/content/Context;

    .line 80
    iput-object p4, p0, Ldjv;->e:Lpqw;

    .line 81
    iput-object p5, p0, Ldjv;->f:Ldjz;

    .line 82
    iput-object p6, p0, Ldjv;->g:Lljx;
    ...
    iput-object v0, p0, Ldjv;->b:Landroid/content/res/Resources;
    ...
    iput-object v0, p0, Ldjv;->a:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Ldjv;->h:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Ldjv;->j:Landroid/content/IntentFilter;

    .line 89
    iget-object v0, p0, Ldjv;->j:Landroid/content/IntentFilter;
    ...
    .line 104
    iget-object v1, p0, Ldjv;->d:Landroid/content/Context;

    iget-object v2, p0, Ldjv;->j:Landroid/content/IntentFilter;
...
.method private final a(Ljava/lang/String;Z)Lhm;
    ...
    .prologue
    .line 441
    iget-object v0, p0, Ldjv;->h:Ljava/util/HashMap;
    ...
    iget-object v2, p0, Ldjv;->d:Landroid/content/Context;

    invoke-direct {v1, v2}, Lhm;-><init>(Landroid/content/Context;)V

    iget-object v2, p0, Ldjv;->b:Landroid/content/res/Resources;
    ...
    iget-object v3, p0, Ldjv;->b:Landroid/content/res/Resources;
    ...
    .line 459
    iget-object v1, p0, Ldjv;->h:Ljava/util/HashMap;
...
.method private final a(Ljava/lang/String;Lhm;ZZLandroid/net/Uri;)V
    ...
    iget-object v0, p0, Ldjv;->a:Ljava/util/HashMap;
    ...
    invoke-virtual {p0, p1, v0}, Ldjv;->b(Ljava/lang/String;Landroid/app/Notification;)V
    ...
    invoke-virtual {p0, p1, v0}, Ldjv;->d(Ljava/lang/String;Landroid/app/Notification;)V

    goto :goto_0

    .line 388
    :cond_3
    iget-object v6, p0, Ldjv;->e:Lpqw;
    ...
    invoke-direct/range {v0 .. v5}, Ldjx;-><init>(Ldjv;Lhm;ZLjava/lang/String;Z)V

    invoke-interface {v6, p5, v0}, Lpqw;->a(Landroid/net/Uri;Llcd;)V
...
.method private final b()Lhm;
    ...
    iget-object v1, p0, Ldjv;->b:Landroid/content/res/Resources;
...
.method private final d(Lqev;)V
    ...
    .line 19067
    iget-boolean v2, p1, Lqev;->c:Z

    .line 304
    if-eqz v2, :cond_0

    .line 305
    iget-object v0, p0, Ldjv;->d:Landroid/content/Context;
    ...
    .line 311
    :goto_0
    invoke-direct {p0}, Ldjv;->b()Lhm;

    move-result-object v2

    .line 19089
    iget-object v6, v5, Lqeu;->b:Ljava/lang/String;
    ...
    iget-object v4, p0, Ldjv;->d:Landroid/content/Context;
    ...
    iget-object v7, p0, Ldjv;->f:Ldjz;

    .line 324
    invoke-virtual {v7, v1}, Ldjz;->a(Ljava/lang/String;)Landroid/content/Intent;
    ...
    .line 332
    invoke-virtual {v5}, Lqeu;->a()Landroid/net/Uri;
    ...
    .line 327
    invoke-direct/range {v0 .. v5}, Ldjv;->a(Ljava/lang/String;Lhm;ZZLandroid/net/Uri;)V
    ...
    invoke-virtual {p0, v1, v0}, Ldjv;->d(Ljava/lang/String;Landroid/app/Notification;)V
...
.method private final d(Lqfg;)V
    ...
    invoke-virtual {p1, v0}, Lqfg;->a(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 8066
    iget-object v5, p1, Lqfg;->a:Lqfc;

    .line 8093
    iget-object v5, v5, Lqfc;->b:Ljava/lang/String;
    ...
    .line 206
    invoke-virtual {v7}, Ldjz;->a()Landroid/content/Intent;
    ...
    invoke-virtual {v0}, Lqfc;->a()Landroid/net/Uri;
    ...
    invoke-virtual {p0, v6, v0}, Ldjv;->b(Ljava/lang/String;Landroid/app/Notification;)V
...
.method protected final declared-synchronized a(Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-super {p0, p1}, Lqfr;->a(Ljava/lang/String;)V
...
.method public final a(Lqfv;)V
    ...
    .prologue
    .line 111
    iput-object p1, p0, Ldjv;->c:Lqfv;

    .line 112
    return-void
.end method

.method protected final a(Lqev;)Z
    .locals 14
    ...
    .line 243
    iget-object v5, p0, Ldjv;->g:Lljx;

    invoke-interface {v5}, Lljx;->a()Z
    ...
    .line 257
    :goto_0
    invoke-direct {p0, v1, v4}, Ldjv;->a(Ljava/lang/String;Z)Lhm;

    move-result-object v2

    .line 15039
    iget-object v8, p1, Lqev;->a:Lqeu;

    .line 15089
    iget-object v8, v8, Lqeu;->b:Ljava/lang/String;
    ...
    iget-object v9, p0, Ldjv;->d:Landroid/content/Context;
    ...
    iget-object v5, p0, Ldjv;->d:Landroid/content/Context;

    iget-object v6, p0, Ldjv;->f:Ldjz;

    .line 270
    invoke-virtual {v6, v1}, Ldjz;->a(Ljava/lang/String;)Landroid/content/Intent;
    ...
    .line 279
    invoke-virtual {v0}, Lqeu;->a()Landroid/net/Uri;
    ...
    invoke-virtual {p0, v1, v0}, Ldjv;->c(Ljava/lang/String;Landroid/app/Notification;)V
    ...
    .line 249
    :cond_0
    iget-object v5, p0, Ldjv;->b:Landroid/content/res/Resources;
...
.method protected final a(Lqfg;)Z
    .locals 14
    ...
    .line 2108
    iget-wide v4, p1, Lqfg;->h:J

    .line 2112
    iget-wide v8, p1, Lqfg;->i:J
    ...
    .line 2222
    iget-object v7, p0, Ldjv;->d:Landroid/content/Context;

    sget v10, Lweb;->cl:I

    new-array v11, v13, [Ljava/lang/Object;

    iget-object v12, p0, Ldjv;->i:Lon;

    .line 2224
    invoke-static {v4, v5}, Ldjv;->a(J)Ljava/lang/String;
    ...
    iget-object v4, p0, Ldjv;->i:Lon;

    .line 2225
    invoke-static {v8, v9}, Ldjv;->a(J)Ljava/lang/String;
    ...
    .line 2227
    invoke-direct {p0, v6, v1}, Ldjv;->a(Ljava/lang/String;Z)Lhm;
    ...
    iget-object v5, p0, Ldjv;->f:Ldjz;

    .line 155
    invoke-virtual {v5}, Ldjz;->a()Landroid/content/Intent;
    ...
    invoke-virtual {p0, v6, v0}, Ldjv;->a(Ljava/lang/String;Landroid/app/Notification;)V
...
.method protected final declared-synchronized b(Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-super {p0, p1}, Lqfr;->b(Ljava/lang/String;)V
...
.method protected final b(Lqev;)Z
    .locals 1

    .prologue
    .line 287
    invoke-direct {p0, p1}, Ldjv;->d(Lqev;)V
...
.method protected final b(Lqfg;)Z
    .locals 1

    .prologue
    .line 172
    invoke-direct {p0, p1}, Ldjv;->d(Lqfg;)V
...
.method protected final c(Lqev;)Z
    .locals 1
...
.method protected final c(Lqfg;)Z
    .locals 1
