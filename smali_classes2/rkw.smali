...
.method public constructor <init>(Landroid/app/Service;Lil;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, Lrkw;->e:Ljava/lang/Runnable;

    .line 45
    iput-object p1, p0, Lrkw;->a:Landroid/app/Service;

    .line 46
    iput-object p2, p0, Lrkw;->b:Lil;

    .line 47
    iput-object p3, p0, Lrkw;->c:Landroid/os/Handler;
...
.method public final declared-synchronized a()V
    ...
    :try_start_0
    iget-boolean v0, p0, Lrkw;->f:Z

    if-eqz v0, :cond_0

    .line 56
    iget-object v0, p0, Lrkw;->a:Landroid/app/Service;
...
.method public final declared-synchronized a(Landroid/app/Notification;Z)V
    ...
    :try_start_0
    iget-object v1, p0, Lrkw;->c:Landroid/os/Handler;

    iget-object v2, p0, Lrkw;->e:Ljava/lang/Runnable;

    invoke-virtual {v1, v2}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    .line 69
    iget-boolean v1, p0, Lrkw;->f:Z

    if-nez v1, :cond_0

    if-eqz p2, :cond_0

    iget-object v1, p0, Lrkw;->a:Landroid/app/Service;
...
.method public final declared-synchronized b()V
    ...
    :try_start_0
    iget-object v0, p0, Lrkw;->c:Landroid/os/Handler;

    iget-object v1, p0, Lrkw;->e:Ljava/lang/Runnable;
