...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lvsz;->a:[Ljava/lang/String;
...
.method public constructor <init>(Landroid/net/Uri;Landroid/content/ContentResolver;)V
    ...
    iput-object v0, p0, Lvsz;->c:Landroid/net/Uri;
    ...
    iput-object v0, p0, Lvsz;->b:Landroid/content/ContentResolver;
...
.method private final a(I)Landroid/graphics/Bitmap;
    ...
    .line 129
    iget-object v0, p0, Lvsz;->b:Landroid/content/ContentResolver;

    iget-object v1, p0, Lvsz;->c:Landroid/net/Uri;

    sget-object v2, Lvsz;->a:[Ljava/lang/String;
    ...
    iget-object v2, p0, Lvsz;->c:Landroid/net/Uri;
...
.method public final a(Landroid/graphics/Point;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, v0}, Lvsz;->a(I)Landroid/graphics/Bitmap;
...
.method public final a(Ljava/io/File;)Lvuf;
    ...
    iget-object v4, p0, Lvsz;->b:Landroid/content/ContentResolver;

    iget-object v5, p0, Lvsz;->c:Landroid/net/Uri;

    invoke-virtual {v4, v5}, Landroid/content/ContentResolver;->openInputStream(Landroid/net/Uri;)Ljava/io/InputStream;

    move-result-object v4

    invoke-direct {v0, v4, v2, v3}, Lvuf;-><init>(Ljava/io/InputStream;J)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object v1, p0, Lvsz;->b:Landroid/content/ContentResolver;
    ...
    invoke-direct {v0, v1}, Lvuf;-><init>(Ljava/io/InputStream;)V
