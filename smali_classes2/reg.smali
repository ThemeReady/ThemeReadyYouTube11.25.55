...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lreg;->g:[J

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lrgl;Lloz;Lwvp;Lwvp;)V
    .locals 1
    ...
    iput-object v0, p0, Lreg;->a:Landroid/content/Context;
    ...
    iput-object v0, p0, Lreg;->j:Landroid/app/NotificationManager;

    .line 67
    new-instance v0, Lrei;

    .line 2361
    invoke-direct {v0, p0}, Lrei;-><init>(Lreg;)V

    .line 67
    invoke-interface {p2, v0}, Lrgl;->a(Lrgm;)V
...
.method private final a(Ljava/lang/String;Ljava/lang/String;Z)Landroid/app/PendingIntent;
    ...
    .line 303
    :cond_0
    iget-object v1, p0, Lreg;->a:Landroid/content/Context;
...
.method private final a(Lnin;)Landroid/net/Uri;
    .locals 2

    .prologue
    .line 321
    iget-object v0, p0, Lreg;->a:Landroid/content/Context;
    ...
    .line 322
    invoke-virtual {p1, v0}, Lnin;->a(I)Lnik;
...
.method private final a(ZLjava/lang/String;Ljava/lang/String;Landroid/net/Uri;JJZZZ)V
    ...
    iget-object v3, p0, Lreg;->a:Landroid/content/Context;
    ...
    .line 164
    iget-object v2, p0, Lreg;->a:Landroid/content/Context;
    ...
    invoke-static/range {v2 .. v7}, Lrho;->b(Landroid/content/Context;ZJJ)Ljava/lang/String;
    ...
    .line 181
    iput-object v2, p0, Lreg;->d:Lhm;

    .line 183
    if-eqz p1, :cond_0

    .line 184
    iget-object v2, p0, Lreg;->d:Lhm;
    ...
    iget-object v4, p0, Lreg;->a:Landroid/content/Context;
    ...
    invoke-direct {p0, v5, p2, v6}, Lreg;->a(Ljava/lang/String;Ljava/lang/String;Z)Landroid/app/PendingIntent;
    ...
    invoke-direct {p0, v3, p2, v4}, Lreg;->a(Ljava/lang/String;Ljava/lang/String;Z)Landroid/app/PendingIntent;
    ...
    invoke-direct {p0, v3, p2, v0}, Lreg;->a(Ljava/lang/String;Ljava/lang/String;Z)Landroid/app/PendingIntent;
    ...
    .line 215
    invoke-direct {p0, p4}, Lreg;->b(Landroid/net/Uri;)Z
    ...
    iget-object v2, p0, Lreg;->e:Landroid/util/Pair;
    ...
    invoke-static/range {v2 .. v7}, Lrho;->a(Landroid/content/Context;ZJJ)Ljava/lang/String;
    ...
    .line 8311
    iget-object v5, p0, Lreg;->a:Landroid/content/Context;
...
.method private final b(Landroid/net/Uri;)Z
    ...
    .prologue
    .line 328
    iget-object v0, p0, Lreg;->e:Landroid/util/Pair;
...
.method public final a()V
    ...
    .line 141
    iget-object v0, p0, Lreg;->j:Landroid/app/NotificationManager;
    ...
    .line 142
    iput-object v2, p0, Lreg;->e:Landroid/util/Pair;

    .line 143
    iput-object v2, p0, Lreg;->f:Landroid/net/Uri;
...
.method final a(Landroid/net/Uri;)V
    ...
    .line 245
    invoke-direct {p0, p1}, Lreg;->b(Landroid/net/Uri;)Z
    ...
    .line 10340
    iput-object p1, p0, Lreg;->f:Landroid/net/Uri;

    .line 10341
    iget-object v0, p0, Lreg;->h:Lloz;

    new-instance v1, Lreh;

    invoke-direct {v1, p0}, Lreh;-><init>(Lreg;)V

    invoke-interface {v0, p1, v1}, Lloz;->a(Landroid/net/Uri;Llcd;)V
...
.method public final a(Ljava/lang/String;Ljava/lang/String;Lnin;JJZZ)V
    .locals 16
    ...
    invoke-direct {v0, v1}, Lreg;->a(Lnin;)Landroid/net/Uri;
    ...
    invoke-direct/range {v3 .. v14}, Lreg;->a(ZLjava/lang/String;Ljava/lang/String;Landroid/net/Uri;JJZZZ)V

    .line 122
    move-object/from16 v0, p0

    invoke-virtual {v0, v7}, Lreg;->a(Landroid/net/Uri;)V

    .line 123
    move-object/from16 v0, p0

    iget-object v2, v0, Lreg;->b:Lwvp;
    ...
    invoke-interface {v2}, Lrgn;->e()V

    .line 124
    return-void
.end method

.method public final a(Ljava/lang/String;Ljava/lang/String;Lnin;Z)V
    .locals 6
    ...
    .line 133
    invoke-direct {p0, p3}, Lreg;->a(Lnin;)Landroid/net/Uri;
    ...
    invoke-direct {p0, v2, p1, p4}, Lreg;->a(Ljava/lang/String;Ljava/lang/String;Z)Landroid/app/PendingIntent;
    ...
    .line 3235
    iput-object v0, p0, Lreg;->d:Lhm;

    .line 3237
    invoke-direct {p0, v1}, Lreg;->b(Landroid/net/Uri;)Z
    ...
    .line 135
    :cond_0
    invoke-virtual {p0, v1}, Lreg;->a(Landroid/net/Uri;)V

    .line 136
    iget-object v0, p0, Lreg;->b:Lwvp;
    ...
    invoke-interface {v0, p1}, Lrgn;->a(Ljava/lang/String;)V

    .line 137
    return-void
.end method

.method public final a(Lrgk;)V
    .locals 0

    .prologue
    .line 72
    iput-object p1, p0, Lreg;->c:Lrgk;

    .line 73
    return-void
.end method

.method public final a(ZLjava/lang/String;Ljava/lang/String;Lnin;JJZZ)V
    .locals 15
    ...
    invoke-direct {p0, v0}, Lreg;->a(Lnin;)Landroid/net/Uri;
    ...
    .line 97
    invoke-virtual {p0, v7}, Lreg;->a(Landroid/net/Uri;)V

    .line 98
    iget-object v2, p0, Lreg;->b:Lwvp;
    ...
    .line 99
    invoke-interface/range {v2 .. v7}, Lrgn;->a(Ljava/lang/String;JJ)V
