...
# instance fields
.field private g:Lqgp;


# direct methods
.method private constructor <init>(Llfo;Ljava/security/Key;Llfo;Lrqt;Llrm;)V
    .locals 3

    .prologue
    .line 66
    invoke-direct {p0, p2, p3, p4}, Lrqu;-><init>(Ljava/security/Key;Llfo;Lrqt;)V

    .line 67
    new-instance v0, Lqgp;

    invoke-direct {v0, p2, p5, p1}, Lqgp;-><init>(Ljava/security/Key;Llrm;Llfo;)V

    iput-object v0, p0, Lqfy;->g:Lqgp;

    .line 1152
    iget-object v0, p0, Lrqu;->c:Lorg/apache/http/protocol/HttpRequestHandlerRegistry;

    .line 68
    const-string v1, "/pudl"

    iget-object v2, p0, Lqfy;->g:Lqgp;
...
.method public static a(Llfo;Ljava/security/Key;Llfo;Lrqt;Llrm;)Lqfy;
    .locals 7
    ...
    invoke-direct/range {v0 .. v5}, Lqfy;-><init>(Llfo;Ljava/security/Key;Llfo;Lrqt;Llrm;)V
    ...
    iput-object v1, v0, Lrqu;->e:Ljava/net/ServerSocket;
    ...
    .line 1146
    iget-object v2, v0, Lrqu;->e:Ljava/net/ServerSocket;
    ...
    iput-object v1, v0, Lrqu;->f:Ljava/util/concurrent/ExecutorService;

    .line 1148
    iget-object v1, v0, Lrqu;->f:Ljava/util/concurrent/ExecutorService;

    new-instance v2, Lrqv;

    invoke-direct {v2, v0}, Lrqv;-><init>(Lrqu;)V
